...
class AverageFact:
    ...
    def insertStockDimention(self,stock):
        try:
            ...
            query = """INSERT INTO khepri_dwh.average_d_stock
    ...
    def insertDateDimention(self,start_date,end_date,date_plan):
        try:
            ...
            query = """INSERT INTO khepri_dwh.average_d_date
    ...
    def insertFact(self,fact_data):
        try:
            query = """INSERT INTO khepri_dwh.average_f
    ...
    def insertFactAgregate(self,fact_data):
        try:
            query = """INSERT INTO khepri_dwh.average_aggr
